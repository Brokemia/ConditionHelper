...
namespace Soukoku.ExpressionParser
{
    ...
    public class Evaluator
    {
        ...
        private Stack<ExpressionToken> _stack = new Stack<ExpressionToken>();

        private Dictionary<string, ExpressionToken[]> _tokenizedCache = new Dictionary<string, ExpressionToken[]>();

        private InfixToPostfixTokenizer _tokenizer = new InfixToPostfixTokenizer();
        ...
        public ExpressionToken Evaluate(string input, bool coerseToBoolean = false)
        {
            ...
            var tokens = _tokenizedCache.TryGetValue(input, out var cachedTokens) ? cachedTokens : _tokenizer.Tokenize(input);
